...
func (p *ApiServiceClient) CreateVideo(ctx context.Context, req *CreateVideoRequest) (r *CreateVideoResponse, err error) {
	var _args ApiServiceCreateVideoArgs
	_args.Req = req
	var _result ApiServiceCreateVideoResult
	if err = p.Client_().Call(ctx, "CreateVideo", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *ApiServiceClient) GetVideoList(ctx context.Context, req *GetVideoListRequest) (r *GetVideoListResponse, err error) {
...
func NewApiServiceProcessor(handler ApiService) *ApiServiceProcessor {
	...
	self.AddToProcessorMap("CreateVideo", &apiServiceProcessorCreateVideo{handler: handler})
...
type apiServiceProcessorCreateVideo struct {
	handler ApiService
}

func (p *apiServiceProcessorCreateVideo) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := ApiServiceCreateVideoArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := ApiServiceCreateVideoResult{}
...
type ApiServiceCreateVideoArgs struct {
	Req *CreateVideoRequest `thrift:"req,1"`
}

func NewApiServiceCreateVideoArgs() *ApiServiceCreateVideoArgs {
	return &ApiServiceCreateVideoArgs{}
}

var ApiServiceCreateVideoArgs_Req_DEFAULT *CreateVideoRequest

func (p *ApiServiceCreateVideoArgs) GetReq() (v *CreateVideoRequest) {
	if !p.IsSetReq() {
		return ApiServiceCreateVideoArgs_Req_DEFAULT
	}
	return p.Req
}

var fieldIDToName_ApiServiceCreateVideoArgs = map[int16]string{
	1: "req",
}

func (p *ApiServiceCreateVideoArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *ApiServiceCreateVideoArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ApiServiceCreateVideoArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ApiServiceCreateVideoArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *ApiServiceCreateVideoArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *ApiServiceCreateVideoArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *ApiServiceCreateVideoArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ApiServiceCreateVideoArgs(%+v)", *p)
}

type ApiServiceCreateVideoResult struct {
	Success *CreateVideoResponse `thrift:"success,0,optional"`
}

func NewApiServiceCreateVideoResult() *ApiServiceCreateVideoResult {
	return &ApiServiceCreateVideoResult{}
}

var ApiServiceCreateVideoResult_Success_DEFAULT *CreateVideoResponse

func (p *ApiServiceCreateVideoResult) GetSuccess() (v *CreateVideoResponse) {
	if !p.IsSetSuccess() {
		return ApiServiceCreateVideoResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_ApiServiceCreateVideoResult = map[int16]string{
	0: "success",
}

func (p *ApiServiceCreateVideoResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ApiServiceCreateVideoResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ApiServiceCreateVideoResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ApiServiceCreateVideoResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *ApiServiceCreateVideoResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *ApiServiceCreateVideoResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *ApiServiceCreateVideoResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ApiServiceCreateVideoResult(%+v)", *p)
}

type ApiServiceGetVideoListArgs struct {
	Req *GetVideoListRequest `thrift:"req,1"`
}
...
var ApiServiceGetVideoListArgs_Req_DEFAULT *GetVideoListRequest

func (p *ApiServiceGetVideoListArgs) GetReq() (v *GetVideoListRequest) {
	if !p.IsSetReq() {
...
type ApiServiceGetVideoListResult struct {
	Success *GetVideoListResponse `thrift:"success,0,optional"`
}
...
var ApiServiceGetVideoListResult_Success_DEFAULT *GetVideoListResponse

func (p *ApiServiceGetVideoListResult) GetSuccess() (v *GetVideoListResponse) {
	if !p.IsSetSuccess() {
